...
const title = 'Farcaster Terms of Use';
const description = 'Terms of Use governing the Farcaster applications';
  ...
  return (
    <>
      ...
      <Para>
        ...
        team+contact@neynar.com, and we’ll do our best to help. Our website and
        the App are owned and provided by Neynar, Inc. In these Terms of Use, we
        won’t use the full corporate name. Instead, we’ll refer to the company
        as “Neynar”. And when we say “we,” “us,” or “our,” that’s also referring
        to the company. We encourage you to read these Terms of Use (the
        “Terms”) and our{' '}
        ...
        to be bound and abide by these Terms. If you do not agree with any part
        of the Terms, you must not use the Services.
      </Para>
      ...
      <Para>
        These include: zero tolerance for abusive users or harassment of others,
        zero tolerance for hate speech, no posting illegal content, no
      ...
      <Para>
        ...
        posting the updated Terms within the Services or through other
      ...
      <Para>
        ...
        Neynar has no responsibility or liability for the deletion or failure to
        store any data or other content maintained or uploaded by the Services.
        You acknowledge that Neynar reserves the right to terminate Accounts (as
        defined below) that are inactive for an extended period of time. You
        further acknowledge that Neynar reserves the right to change these
      ...
      <Para>
        ...
        provide, including the Site and App, at Neynar’s sole discretion without
        notice. Neynar may restrict access to some parts of the Services. Neynar
        will not be liable for any outages to the Services that may occur, for
        whatever reason.
      </Para>
      <H2>Who May Use the Services?</H2>
      <Para>
        You may use the Services only if (1) you are 18 years or older (or the
        legal age of majority in your jurisdiction) or are between 13 years and
        17 years old and your parent or legal guardian must agree to be bound by
        these Terms and (2) capable of forming a binding contract with Neynar,
        and are not barred from using the Services under applicable law. If you
        want to use certain features of the Services, you’ll have to create an
        ...
        update such information to keep it accurate, complete and up-to-date. If
        you don’t, we reserve the right to suspend or terminate your Account.
        You agree that you won’t disclose your Account login credentials to
      ...
      <Para>
        ...
        no reason, including if, in our opinion, there has been a violation of
        any provision of these Terms or other posted policies, guidelines, or
        rules.
      </Para>
      <H2>Feedback</H2>
      <Para>
        ...
        transferable, worldwide, perpetual, irrevocable, sub-licensable (through
        multiple tiers), fully-paid, royalty-free license to use, copy, modify,
        create derivative works based upon, and otherwise exploit for any
        purpose the Feedback you provide us.
      </Para>
      ...
      <Para>
        ...
        Services from outside of the United States, you do so at your own risk.
        ...
        jurisdiction. Software available in connection with the Services and the
        ...
        Downloading or using the software underlying the Services is at your
        sole risk.
      </Para>
      ...
      <Para>
        ...
        “User Content” means any Content that Users (including you) provide to
        be made available through the Services including without limitation, any
        reviews, ratings, and comments you provide. For clarity, Content
        includes without limitation User Content.
      </Para>
      <Para>
        Our Content Ownership: Neynar does not claim any ownership rights in any
        ...
        to the foregoing, as between you and Neynar, Neynar is the sole owner of
        and will retain ownership of all right, title, and interest in the
        Services and Content, including all underlying software, algorithms,
        interfaces, technology, databases, tools, know-how, processes and
        methods used to provide or deliver the Services, documentation,
        aggregate data related to the Services, all improvements, modifications
        or enhancements to (or derivative works of) the foregoing (regardless of
        inventorship or authorship), and all Intellectual Property Rights in and
        to any of the foregoing. You acknowledge that the Services and Content
        are protected by copyright, trademark, and other laws of the United
        States and foreign countries. You agree not to remove, alter, or obscure
      ...
      <Para>
        ...
        Neynar on or through the Services will infringe, misappropriate, or
      ...
      <Para>
        Third-Party Content: Under no circumstances will Neynar be liable in any
        way for any content or materials of any third parties (including Users),
        ...
        You acknowledge that Neynar does not pre-screen Content, but that Neynar
        ...
        the Services. Without limiting the foregoing, Neynar and its designees
        will have the right to remove any Content that violates these Terms or
        is deemed by Neynar, in its sole discretion, to be otherwise
      ...
      <Para>
        ...
        of the Services is solely for your personal use. When using the
      ...
      <ul className="bullets">
        ...
        <li>
          <Para>
            ...
            storing any unlawful material or communications or for deceptive or
            fraudulent purposes.
          </Para>
        </li>
        <li>
          <Para>
            ...
            competing with Neynar services.
          </Para>
        </li>
        <li>
          <Para>
        ...
        <li>
          <Para>
            You will only use the Services for your own use and will not resell
      ...
      <ul className="bullets">
        <li>
          <Para>
            ...
            within the Services, Neynar’s name, any Neynar trademark, logo or
            other proprietary information, or the layout and design of any page
            or form contained on a page, without Neynar’s express written
            consent;
          </Para>
        </li>
        <li>
          <Para>
            use the Services in any manner that violates federal, state, local,
            or international law or regulation, including, without limitation,
            any laws regarding related to the export of data or software to and
        ...
        <li>
          <Para>
            ...
            circumvent any technological measure implemented by Neynar or any of
            Neynar’s providers or any other third party (including another User)
        ...
        <li>
          <Para>
            ...
            interfere with any parts of the Services, or any server, computer or
        ...
        <li>
          <Para>
            ...
            Services (including the App) or any of the software used to operate
            the Services;
          </Para>
        </li>
        <li>
      ...
      <Para>
        ...
        certain transactions as available. To facilitate this, you may be given
        the option to sign, consent to, or agree to certain documents including,
        but not limited to, these Terms, policies, quotes, updates,
        ...
        (“Communications”) electronically by either checking the appropriate box
        or engaging in a similar online process as instructed online. You agree
        that by checking the appropriate box within or adjacent to the
        ...
        to be bound by the terms and provisions in such Communication just as if
        you had signed your name to a paper document.
      </Para>
      ...
      <Para>
        ...
        that the content be removed. The notice must include: (a) your (or your
        agent&#39;s) physical or electronic signature; (b) identification of the
        copyrighted work on our Site that is claimed to have been infringed (or
        a representative list if multiple copyrighted works are included in one
        notification); (c) identification of the content that is claimed to be
        infringing or the subject of infringing activity, including information
        reasonably sufficient to allow us to locate the content on the Services;
        (d) your name, address, telephone number and email address (if
        available); (e) a statement that you have a good faith belief that use
        of the content in the manner complained of is not authorized by you or
        your agent or the law; and (f) a statement that the information in the
        notification is accurate and, under penalty of perjury, that you or your
        agent is authorized to act on behalf of the copyright owner. You may
        read more information about the DMCA{' '}
        <a href="http://www.copyright.gov/dmca" title="DMCA">
          here
        </a>
        .
      </Para>
      <Para>
        ...
        information to the Copyright Agent (identified below): (a) your physical
        or electronic signature; (b) identification of the content that has been
        removed or to which access has been disabled and the location at which
        the content appeared before it was removed or disabled; (c) a statement
        ...
        and (d) your name, address, telephone number, and email address, a
        statement that you consent to the jurisdiction of the federal courts
        located within the state of California. and a statement that you will
        accept service of process from the person who provided notification of
        the alleged infringement.
      </Para>
      <Para>
        If a counter-notice is received by the Copyright Agent, Neynar will send
      ...
      <Para>
        ...
        the DMCA. We suggest that you consult your legal advisor before filing a
        notice or counter-notice.
      </Para>
      <Para>
        In accordance with the DMCA and other applicable law, Neynar has adopted
        a policy of terminating, in appropriate circumstances and at Neynar’s
        sole discretion, Users who are deemed to be repeat infringers. Neynar
        may also at its sole discretion limit access to the Services and/or
      ...
      <Para>
        The following disclaimers are made on behalf of Neynar, our affiliates,
        subsidiaries, parents, successors and assigns, and each of our
        respective officers, directors, employees, agents, and shareholders. THE
        SERVICES ARE PROVIDED ON AN “AS IS” BASIS AND WITHOUT ANY WARRANTY OR
        CONDITION, EXPRESS, IMPLIED OR STATUTORY. WE DO NOT GUARANTEE AND DO NOT
        PROMISE ANY SPECIFIC RESULTS FROM USE OF THE SERVICES. TO THE FULLEST
        ...
        WARRANTIES, SO THE FOREGOING DISCLAIMER MAY NOT APPLY TO YOU. WE DO NOT
        WARRANT THAT YOUR USE OF THE SERVICES WILL BE ACCURATE, COMPLETE,
        RELIABLE, CURRENT, SECURE, UNINTERRUPTED, ALWAYS AVAILABLE, OR
        ERROR-FREE, OR WILL MEET YOUR REQUIREMENTS, THAT ANY DEFECTS IN THE
        SERVICES WILL BE CORRECTED, OR THAT THE SERVICES IS FREE OF VIRUSES OR
        OTHER HARMFUL COMPONENTS. WE DISCLAIM LIABILITY FOR, AND NO WARRANTY IS
        MADE WITH RESPECT TO, CONNECTIVITY AND AVAILABILITY OF THE SERVICES. WE
        ARE NOT RESPONSIBLE FOR ANY RESULTS OR ADVICE PROVIDED VIA THE SERVICES,
        AND DISCLAIM ALL LIABILITY WITH RESPECT THERETO.
      </Para>
      <H2>Indemnity</H2>
      <Para>
        To the extent permitted by law, you agree to indemnify, protect and hold
        Neynar and its parents, subsidiaries, affiliates, and assigns, and their
        respective officers, directors, employees, agents, representatives and
        service providers harmless from any and all claims, demands, damages,
        suits, losses, liabilities and causes of action (including without
        limitation, the cost of defense, attorneys&#39; fees, as well as the
        payment of any final judgment rendered against or settlement agreed upon
        by Neynar or its parent, subsidiary and/or affiliated companies) arising
        directly or indirectly from, as a result of, or in connection with: (i)
        your User Content; (ii) your failure to comply with any of these Terms;
        (iii) your violation of any applicable laws, rules, or regulations
        related to your use of the Services; and (iv) your use of the Services.
        Neynar reserves the right, at its own cost, to assume the exclusive
        defense and control of any matter otherwise subject to indemnification
        by you, in which event you will fully cooperate with Neynar in asserting
        any available defenses. Neynar will provide notice to you of any such
        ...
        reasonable requests assisting Neynar’s defense of such matter. You may
        not settle or compromise any claim against the indemnified parties
        without Neynar’s written consent. If you are a California resident, you
        ...
        affected his or her settlement with the debtor or releasing party.” If
      ...
      <Para>
        ...
        WITH THESE TERMS OR FROM YOUR USE OF, OR INABILITY TO USE, THE SERVICES,
        WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE),
        PRODUCT LIABILITY, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT NEYNAR
        ...
        ABOVE LIMITATION MAY NOT APPLY TO YOU. IN NO EVENT WILL NEYNAR’S TOTAL
        LIABILITY ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR FROM THE
        USE OF OR INABILITY TO USE THE SERVICES EXCEED ONE HUNDRED US DOLLARS
        ($100). THE EXCLUSIONS AND LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE
        FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN NEYNAR AND YOU.
      </Para>
      <Para>
      ...
      <Para>
        ...
        compliance with any applicable local, state, and federal laws, rules and
        regulations.
      </Para>
      <H2>Reliance on Information Posted</H2>
      <Para>
        The information presented throughout the Services is made available for
        general information purposes only. Neynar does not warrant the accuracy,
        completeness, or usefulness of the information. Any reliance you place
        on such information is at your own risk. We disclaim all liability and
        responsibility arising from any reliance placed on such materials by any
        visitor to, or User of, the Services, or by anyone who may be informed
      ...
      <Para>
        ...
        the content, products, or services on or available from those websites
        or resources or links displayed on such websites. You acknowledge sole
      ...
      <Para>
        ...
        from Neynar or anyone calling on its behalf, you expressly consent to be
        contacted by Neynar and anyone calling on its behalf for any and all
        purposes arising out of or relating to this Agreement or your use of the
        Services, at any telephone number, or physical or electronic address you
        provide or at which you may be reached. You agree we may contact you in
        any way, including SMS messages (including text messages), calls using
        prerecorded messages or artificial voice, and calls and messages
        delivered using an auto-telephone dialing system or an automatic texting
        ...
        (including prerecorded and artificial voice and autodialed) from Neynar,
        its agents, representatives, affiliates or anyone calling on its behalf
        at the specific number(s) you have provided to Neynar, or numbers we can
        ...
        Account or use of the Services. You certify, warrant and represent that
        the telephone numbers that you have provided to us are your correct and
        current contact numbers. You represent that you are permitted to receive
        calls at each of the telephone numbers you have provided to us and agree
        to promptly alert us whenever you stop using a particular telephone
        number. Your cellular or mobile telephone provider will charge you
        according to the type of plan you carry. You also agree that we may
        contact you by email, using any email address you have provided to us or
        that you provide to us in the future. We may listen to and/or record
        phone calls between you and our representatives without notice to you as
        ...
        communications from us in electronic form should we so elect, including
        any and all disclosures and other communications that are required by
        law.{' '}
      </Para>
      <H2>Governing Law and Venue</H2>
      <Para>
        Except as otherwise provided in the Dispute Resolution provision below,
        these Terms will be governed by the laws of the State of California,
        without regard to its conflict of laws provisions. With respect to any
        disputes or claims not subject to arbitration, as set forth above, you
        and Company each hereby agree that each submit to the personal and
      ...
      <Para>Please read this section carefully as it affects your rights.</Para>
      <Para>
        ...
        accordance with the terms of this Arbitration Agreement, except that you
        ...
        behalf. You agree that, by entering into these Terms of Use, you and
      ...
      <Para>
        ...
        CLAIM(S), EXCEPT THAT YOU MAY PURSUE A CLAIM FOR AND THE ARBITRATOR MAY
        AWARD PUBLIC INJUNCTIVE RELIEF UNDER APPLICABLE LAW TO THE EXTENT
        REQUIRED FOR THE ENFORCEABILITY OF THIS PROVISION.
      </Para>
      <Para>
        c. Pre-Arbitration Dispute Resolution. Company is always interested in
        resolving disputes amicably and efficiently, and most customer concerns
        can be resolved quickly and to the customer’s satisfaction by emailing
        customer support at team+contact@neynar.com. If such efforts prove
        unsuccessful, a party who intends to seek arbitration must first send to
        the other, by certified mail, a written Notice of Dispute (“Notice”).
        The Notice to Company should be sent to Neynar, Inc. 221 West 9th
        Street, Wilmington, DE 19801 (“Notice Address”). The Notice must (i)
        describe the nature and basis of the claim or dispute and (ii) set forth
        the specific relief sought. If Company and you do not resolve the claim
      ...
      <Para>
        ...
        <a href="http://www.adr.org" title="American Arbitration Association">
          http://www.adr.org
        </a>
        . Information about the AAA Rules and fees for consumer disputes can be
        found at the AAA’s consumer arbitration page,{' '}
        <a
        ...
        follow the provisions of these Terms of Use as a court would. All issues
        are for the arbitrator to decide, including issues relating to the
        scope, enforceability, and arbitrability of this Arbitration Agreement.
        ...
        court can award to an individual under these Terms of Use and applicable
        law. Decisions by the arbitrator are enforceable in court and may be
        overturned by a court only for very limited reasons. Unless Company and
        ...
        parties are unable to agree on a location, the determination will be
        made by AAA. If your claim is for $10,000 or less, Company agrees that
        you may choose whether the arbitration will be conducted solely on the
        ...
        your claim exceeds $10,000, the right to a hearing will be determined by
      ...
      <Para>
        ...
        arbitrator fees (collectively, the “Arbitration Fees”) will be governed
        by the AAA Rules, unless otherwise provided in this Arbitration
        Agreement. If the value of the relief sought is $75,000 or less, at your
        request, Company will pay all Arbitration Fees. If the value of relief
        ...
        Arbitration Fees, Company will pay your portion of such fees. In
        ...
        Company will pay as much of the Arbitration Fees as the arbitrator deems
        necessary to prevent the arbitration from being cost-prohibitive. Any
      ...
      <Para>
        ...
        parties agree to replace such term or provision with a term or provision
        ...
        Arbitration Agreement will be enforceable as so modified. If a court or
      ...
      <Para>
        ...
        provision in these Terms of Use to the contrary, Company agrees that if
        it makes any future change to this Arbitration Agreement (other than a
        change to the Notice Address) while you are a user of the Service, you
        may reject any such change by sending Company written notice within
        ...
        Arbitration Agreement as of the date you first accepted these Terms of
      ...
      <Para>
        ...
        lack of use or if Company believes that you have violated or acted
        inconsistently with the letter or spirit of these Terms of Use. Any
        ...
        appropriate law enforcement authorities. Company may also in its sole
        ...
        your access to the Service under any provision of these Terms of Use may
        be effected without prior notice, and acknowledge and agree that Company
        ...
        such files or the Service. Further, you agree that Company will not be
      ...
      <Para>
        ...
        such right or provision will be effective only if in writing and signed
        by a duly authorized representative of Neynar. Except as expressly set
      ...
      <H2>Entire Terms</H2>
      <Para>
        Except as otherwise stated herein or otherwise amended and agreed to by
        you and Neynar, these Terms constitute the entire and exclusive
        understanding and agreement between Neynar and you regarding your use of
        the Services, and these Terms supersede and replace any and all prior
        oral or written understandings or agreements between Neynar and you
        regarding the use of the Services. If any provision of these Terms is
        ...
        force and effect - except as otherwise described in Dispute Resolution
        by Binding Arbitration section. You may not assign or transfer these
        Terms, by operation of law or otherwise, without Neynar’s prior written
        consent. Any attempt by you to assign or transfer these Terms, without
        such consent, will have no legal effect. Neynar may freely assign or
      ...
      <Para>
        ...
        (TDD). You may contact us at team+contact@neynar.com.
      </Para>
      <H2>U.S. Government Restricted Rights</H2>
      <Para>
        The Services are made available to the U.S. government with “RESTRICTED
        ...
        252.227-7013 et seq. or its successor. Access or use of the Services
        (including the software that enables the Services) by the U.S.
        government constitutes acknowledgement of our proprietary rights in the
        Services (including such software).
      </Para>
      ...
      <Para>
        ...
        disability (so long as such disability can be reasonably accommodated),
        or any other status protected by applicable law. Neynar encourages all
      ...
      <Para>
        ...
        contact us at:{' '}
        <a href="mailto:team+contact@neynar.com" title="Email Neynar">
