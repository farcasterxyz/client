...
const SpaceProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // The scheduled "Go live" handler and the live page's auto-join effect can
  ...
  // Deliberate session refreshes (explicit spaceSessionId) are never deduped.
