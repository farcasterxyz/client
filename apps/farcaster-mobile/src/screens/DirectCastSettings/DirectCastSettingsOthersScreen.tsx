...
type DirectCastSettingsOthersScreenProps = NativeStackScreenProps<
  CommonStackParamList,
  'DirectCastSettingsOthers'
>;

const DirectCastSettingsOthersScreen =
  buildScreen<DirectCastSettingsOthersScreenProps>(
...
DirectCastSettingsOthersScreen.displayName = 'DirectCastSettingsOthersScreen';

export { DirectCastSettingsOthersScreen };
