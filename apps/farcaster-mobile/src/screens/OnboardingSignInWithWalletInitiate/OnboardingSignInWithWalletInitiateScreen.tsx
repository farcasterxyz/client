...
import { AtomsButton } from 'farcaster-expo/src/components/design-system/atoms/Button';
...
type OnboardingSignInWithWalletInitiateScreenProps = NativeStackScreenProps<
  UnauthedStackParamList,
  'OnboardingSignInWithDesktopInitiate'
>;

const OnboardingSignInWithWalletInitiateScreen =
  buildScreen<OnboardingSignInWithWalletInitiateScreenProps>(
...
OnboardingSignInWithWalletInitiateScreen.displayName =
  'OnboardingSignInWithWalletInitiateScreen';

export { OnboardingSignInWithWalletInitiateScreen };
