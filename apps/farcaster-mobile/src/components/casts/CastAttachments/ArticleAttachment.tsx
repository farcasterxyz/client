...
const ArticleAttachment: React.FC<ArticleAttachmentProps> = ({
  ...
  const attachmentWrapperStyle = React.useMemo(
    () => [
      t.flex,
      { borderRadius: 12 },
  ...
  const attachmentImageStyle = React.useMemo(
    () => [
      t.roundedT,
      t.borderBHairline,
      t.borderDefault,
    ...
    [t.borderBHairline, t.borderDefault, t.roundedT, t.wFull],
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text2 weight="regular" size={'sm'} color="secondary" numberOfLines={2}>
          {og.description}
        </Text2>
      </View>
    </TouchableOpacity>
