...
const FarcasterReactionIcon = React.memo(
  ({ color, size = 16 }: { color: string; size?: number }) => {
    return (
      <Svg width={size} height={size} viewBox="180 180 720 720" fill="none">
        <Path
...
FarcasterReactionIcon.displayName = 'FarcasterReactionIcon';

export { FarcasterReactionIcon };
