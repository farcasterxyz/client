...
const StorageWarningRenderer: React.FC<NotificationRendererProps> = ({
  group,
  content,
}) => {
  const t = useTheme();
...
export const renderStorageWarning: NotificationRenderer = (props) => (
  <StorageWarningRenderer {...props} />
);
