...
import { RedeemWarpsForUsdc } from './transactions/RedeemWarpsForUSDC';
...
type WarpsTransactionProps = {
  transaction: ApiWarpsTransaction;
};

const WarpsTransaction: React.FC<WarpsTransactionProps> = ({ transaction }) => {
  switch (transaction.memo) {
    ...
    case 'request-redeem-warps-for-usd':
      return <RedeemWarpsForUsdc transaction={transaction} />;
    default:
      return null;
  }
};

WarpsTransaction.displayName = 'WarpsTransaction';

export { WarpsTransaction };
