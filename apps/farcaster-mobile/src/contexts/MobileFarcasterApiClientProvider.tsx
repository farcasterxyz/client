  ...
  memo(({ children }) => {
    ...
    return (
      <FarcasterApiClientProvider
        ...
        // isOffline is intentionally NOT passed here. ConnectionStatusProvider
        // owns the single NetInfo subscription and calls
        // apiClient.updateOptions there before handing the same event to React
        // Query's setOnline, so the flag is current ahead of the synchronous
        // on-reconnect retry resume. Re-adding this prop would race that
        // ordering with a stale effect-applied value.
