...
import { FontWeight, Text2 } from './Text';
...
export const ButtonGroup: FC<ButtonGroupProps> = memo(
  ({ options, size = 'base', minIconWidth = 24, bordered = true }) => {
    return (
      <View>
  ...
  ({
    ...
    const borderStyles = useMemo(() => {
      ...
      if (isFirstOption) {
        ...
        styles.push(t.roundedTLg);
      }

      if (isLastOption) {
        styles.push(t.roundedBLg);
      }

      return styles;
    }, [isFirstOption, isLastOption, t, bordered]);
