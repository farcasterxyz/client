...
import { ensureBoundedX } from '../utils';

const labelWidth = 90;

export const TokenLineChartMaxLabel = React.memo(
  ({
    lineChart,
    animatedPoints,
    chartColors,
    ...
    const maxPriceParagraphContent = useDerivedValue(() => {
    ...
    return (
      <Paragraph
        ...
        y={10}
        width={labelWidth}
        paragraph={maxPriceParagraphContent}
      />
    );
  },
);
