          ...
          >
            ...
            >
              <Text2 color="secondary" size="base" align="center">
                ...
                when the order starts filling. The market has to pass your price
                by enough to cover network and trading fees. On low-fee chains
                like Base that gap is small; on Ethereum it can be several
                percent, especially on small orders.
              </Text2>
            </View>
